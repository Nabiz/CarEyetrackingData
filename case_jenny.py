...
def case_jenny(all_data):
    ...
    for fix in fixations:
        ...
        elif fix["hit_object"] == "signD6":
            sign_pedestrian.append(fix)
    ...
    for event in events:
        if event["info"] == "Hit Jenny" and jenny_hit_event is None:
    ...
    # for sp in sign_pedestrian:
    #     ax1.axvline(x=sp["timestamp"], color='blue', linestyle=':', linewidth=1.5, alpha=0.7)
    #
    # # Title and layout
